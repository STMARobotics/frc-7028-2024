...
public class TurretSubsystem extends SubsystemBase {
   ...
   */
  public void setYawTarget(Rotation2d yaw) {
    yawMotor.setControl(yawControl.withPosition(yaw.getRotations()));
  }
   ...
   * @param pitch pitch
   */
  public void setPitchTarget(Rotation2d pitch) {
    pitchMotor.setControl(pitchControl.withPosition(pitch.getRotations()));
  }

  /**
   * Loads a note from the amper/intake
   */
  public void load() {
