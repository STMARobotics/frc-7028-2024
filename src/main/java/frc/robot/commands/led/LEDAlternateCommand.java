...
/**
 * Command to create an animation on the LEDs where ever other LED lights up with a given color, and they swap on an
 * interval.
 */
public class LEDAlternateCommand extends Command {
   ...
   */
  public LEDAlternateCommand(LEDSubsystem ledSubsystem, Color color1, Color color2, Measure<Time> interval) {
