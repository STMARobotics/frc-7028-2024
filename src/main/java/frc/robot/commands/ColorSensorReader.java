...
import static frc.robot.Constants.IndexerConstants.PORT_ID_SHOOTER_SENSOR;
...
public class ColorSensorReader implements Runnable {
  ...
  private final MultiplexedColorSensor shooterColorSensor = new MultiplexedColorSensor(Port.kMXP, PORT_ID_SHOOTER_SENSOR);
  ...
  private AtomicReference<ColorSensorValues> shooterValues = new AtomicReference<>();
  ...
  public void run(){
    ...
    shooterValues.set(shooterColorSensor.getValues());
  }
   ...
   */
  public ColorSensorValues getShooterValues() {
    return shooterValues.get();
  }
